...
export type PropertySettings = { property_id: string; electric_rate: number; water_rate: number; water_billing_method: "meter" | "per_person" | "flat_room"; bill_day: number; due_day: number; late_fee: number; promptpay_id: string | null; account_name: string | null; invoice_note: string | null };
